...
def save_result_json(pred_bboxes, pred_labels, pred_scores,
    ...
    res = []
    for image_idx in range(len(pred_bboxes)):
        for bb_idx in range(len(pred_bboxes[image_idx])):
            tmp = OrderedDict()
            tmp["image_id"] = gt_image_ids[image_idx].item()
            tmp["category_id"] = pred_labels[image_idx][bb_idx]
            tmp["bbox"] = pred_bboxes[image_idx][bb_idx,:]
            tmp["score"] = pred_scores[image_idx][bb_idx]
            res.append(tmp)
